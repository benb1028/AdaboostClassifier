...
max_classifiers = 30
n_classifiers = list(range(1, max_classifiers))
...
print(f'Tree Model: {tree_max_acc:.4%}')
print(f'SVC Model: {svc_max_acc:.4%}')
print(f'Default Model: {tree_max_acc:.4%}')
fig1 = plt.figure()
...
fig1.legend([(tree_acc_list, tree_error_rate_list), (svc_acc_list, svc_error_rate_list), 
            (skl_default_acc_list, skl_default_error_rate_list)],
           ('Our Algorithm - Binary Tree Classifier', 'Our Algorithm - SupportVector Classifier',
